...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
			...
			<img src="assets/images/logo-ping.png" style="width:150px;height:50px;" alt="">
              <!-- <i class="fa fa-line-chart"></i> -->
              <!-- P<span style="color:red">!</span>NG 2019 -->
            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <a href="#footer" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Let us discuss together!</a>
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <h2 class="mb-5 text-center" data-aos="fade-up">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="assets/images/project/project-image04.jpg" class="img-fluid" alt="project image">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="assets/images/project/project-image05.jpg" class="img-fluid" alt="project image">
